...
public class RecursionTest {
    ...
    /* The following are tests for the extra methods */
    
    /*@Test
    public void test38dup(){
        String s = "";
        assertEquals("", Recursion.dup(s));
    }
    
    @Test
    public void test39dup(){
        String s = "amsterdam";
        assertEquals("aammsstteerrddaamm", Recursion.dup(s));
    }
    
    @Test
    public void test40dup(){
        String s = "101010";
        assertEquals("110011001100", Recursion.dup(s));
    }*/
}
